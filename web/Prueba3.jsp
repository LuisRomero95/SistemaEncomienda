...
<html>
    ...
    <body>
        ...
        <select name="txtNivel" id="cargaCatalogo">
            <option value="">--Seleccionar--</option>
            <option id="marca_id"></option>
        </select> 
<script type="text/javascript">
    ...
    function cargarXML(xml){
        ...
        for(var i = 0; i < resultado.length; i++){
            ...
            mar += resultado[i].getElementsByTagName("Make_Name")[0].textContent;
            tabla += "</td><td>";
            tabla += resultado[i].getElementsByTagName("Model_Name")[0].textContent;
            tabla += "</td></tr>";            
        }
        document.getElementById("demo").innerHTML = tabla;
        document.getElementById("marca_id").innerHTML = mar;
    }            
</script>       
    </body>   
</html>
