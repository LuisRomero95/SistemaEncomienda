...
//var index_ = function () {
    ...
    _private.setBarras3 = function (data) {
        ...
        var arreglado = objeto.map( item => { 
            return { año: item.tiempo , empresa: item.empresa, persona: item.persona }; 
        });
    ...
    _private.setBarras4 = function (data) {
        ...
        var arreglado = objeto.map( item => { 
            return { mes: item.tiempo , empresa: item.empresa, persona: item.persona }; 
        });
    ...
    _private.setBarrasFecha1 = function (data) {
        ...
        var chart = AmCharts.makeChart("chartdiv1", {
            ...
            "theme": "none",
            "titles": [{
                    "text": "Reporte de cantidad de clientes según el tipo y el mes",
                    "size": 16
                }], 
            "legend": {
                "horizontalGap": 10,
...
//        alert(objeto.length);
    ...
    _private.setLineasFecha1 = function (data) {
        ...
        "type": "serial",
        "titles": [{
                "text": "Reporte de cantidad de clientes según la fecha",
                "size": 16
            }],           
        "theme": "light",
        "marginRight": 40,
    ...
    _private.setBarrasFecha2 = function (data) {
        ...
        var chart = AmCharts.makeChart("chartdiv3", {
            "type": "serial",
            "titles": [{
                "text": "Reporte de cantidad de clientes por tipo según el mes",
                "size": 16
            }],               
             "theme": "light",
             "marginRight":30,
