    ...
    <body>
        ...
        data.setValue("acura", 1);
        data.setValue("alpina", 1);
        data.setValue("aston-martin", 2);
        data.setValue("bmw", 3);
        //Generar el gráfico
        JFreeChart grafico = ChartFactory.createPieChart("vehiculos según su uso", data, true, true,true);
        //leyenda, letreros emergentes, activado los enlaces
