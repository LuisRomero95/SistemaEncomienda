               ...
               <form name="frmInsertarPrecio" method="POST" action="SERVPrecio" autocomplete="off" align="center">
                   ...
                   <div class="col-md-6 col-md-offset-3">
                       ...
                       <div class="form-group">
                           ...
                           <br>
                           <input class="form-control" id="convertido" name="convertido" readonly="" type="text">    
                       </div>
                   ...
                   <div class="col-md-6 col-md-offset-3">
                       ...
                       <div id="ReportarPrecio"></div>
                       <br>
                       <div class="form-group">
                           <div align="center">
                               <input type="submit" name="btnInsertar" value="Insertar" id="insertar2" class="btn btn-success btn-lg" >
